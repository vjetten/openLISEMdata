...
rainfilename = 'GPM monsoon 2014.txt'
# ioutput file name for openLISEM listing all maps
inputdir = 'C:/data/India/GPM/june-sep2014/'
...
maskmapname = 'C:/CRCLisem/Narmada1/Base/dem0.map' #'C:/data/India/narmada/maps/dem.map'
